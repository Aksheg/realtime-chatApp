# Connecting to React to Chat Engine!

This repo shows how to add chat functionality into a React project with [Chat Engine](https://chatengine.io).

## Setup Steps

These steps assume you have already setup one of the server projects in (for example, `server-express`).
